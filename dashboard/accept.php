    ...
    <div class="flex items-center">
        <div class="flex items-center ms-3">
            ...
            <ul class="py-1" role="none">
                <li>
                <a href="../dashboard/index.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Dashboard</a>
                </li>
                <li>
...
<div class="w-full text-sm text-left rtl:text-right text-gray-500">
    ...
    <tbody>
        ...
        if (mysqli_num_rows($result) > 0) {
            // Menampilkan setiap baris data dari tabel 'report'
            while($row = mysqli_fetch_assoc($result)) {
                echo "<tr class='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>";
                echo "<td class='w-4 p-4'>
                        <div class='flex items-center'>
                            <input id='checkbox-table-search-" . $row["id"] . "' type='checkbox' class='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600'>
                            <label for='checkbox-table-search-" . $row["id"] . "' class='sr-only'>checkbox</label>
                        </div>
                    </td>";
                echo "<th scope='row' class='px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white'>" . $row["nama"] . "</th>";
                echo "<td class='px-6 py-4'>" . $row["email"] . "</td>";
                echo "<td class='px-6 py-4'>" . $row["kelas"] . "</td>";
                echo "<td class='px-6 py-4'>" . $row["masalah"] . "</td>";
            ...
            echo "<tr><td colspan='6' class='px-6 py-4 text-center'>Tidak ada data ditemukan</td></tr>";
        }
        // Menutup koneksi
