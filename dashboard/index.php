...
$totalLaporanMasuk = query("SELECT COUNT(*) as total FROM report");

$historyNama = query("SELECT nama, masalah FROM report ORDER BY id DESC LIMIT 4");
$namaPertama = $historyNama[0]['nama'] ?? 'Nama tidak tersedia';
$masalahPertama = $historyNama[0]['masalah'] ?? 'Masalah tidak tersedia';
    ...
    <div class="sidebar">
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            ...
            <div class="flex items-center justify-start rtl:justify-end">
               ...
               <img src="../style/img/idn.png" class="w-16 m-5" alt="">
                <span class="self-center text-xl font-bold sm:text-2xl whitespace-nowrap dark:text-white">Laporkan</span>
                </a>
            </div>
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Laporan Terkirim</span>
                    <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">3</span>
                    </a>
                </li>
                <li>
                    <a href="../dashboard/users.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
    ...
    <div class="px-6 py-8">
      <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-8 mb-5">
          <h1 class="text-3xl font-bold mb-10"> Website Laporkan</h1>
          <div class="flex items-center justify-between">
            <div class="flex items-stretch">
              <div class="text-gray-400 text-xs">Website<br>Anti Bullying</div>
              <div class="h-100 border-l mx-4"></div>
              <div class="flex flex-nowrap -space-x-3">
                <div class="h-9 w-9">
                  <img class="object-cover w-full h-full" src="../style/img/idn.png">
                </div>
              </div>
            </div>
          ...
          <div class="grid grid-cols-2 gap-x-20 ">
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="col-span-2">
                  <div class="p-4 bg-green-100 rounded-xl">
                    <div class="font-bold text-xl text-gray-800 leading-none">Good day, <br><?= $_SESSION['name'] ?></div>
                    <div class="mt-5">
                ...
                <div class="col-span-2">
                  <div class="p-4 bg-purple-100 rounded-xl text-gray-800">
                    <div class="font-bold text-xl leading-none">Jumlah Laporan</div>
                    <div class="mt-2 font-bold"><?= $totalLaporanMasuk[0]['total']?></div>
                  </div>
                </div>
              </div>
            </div>
            <div>
              ...
              <div class="space-y-4">
              <?php
              if (empty($historyNama)) {
                  echo "Tidak ada laporan tersedia.";
              } else {
                 
                  foreach ($historyNama as $row):
                      $nama = htmlspecialchars($row['nama']);
                      $masalah = htmlspecialchars($row['masalah']);
                      ?>
                      <div class="p-4 bg-white border rounded-xl text-gray-800 space-y-2">
                          <div class="flex justify-between">
                              <div class="text-gray-400 font-bold text-xs"><?= $nama ?></div>
                              <div class="text-gray-400 text-xs">4h</div>
                          </div>
                          <a href="javascript:void(0)" class="font-semibold hover:underline"><?= $masalah ?></a>
